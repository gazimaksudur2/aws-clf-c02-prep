...
//
// Output: src/data/exams/aws-clf-c02.json
...
function main() {
  ...
  const bank = {
    ...
    sourceNote:
      'Regenerated by scripts/parse-questions.js from the sibling README.md checklist.',
    questions,
  };
  writeFileSync(OUTPUT_PATH, JSON.stringify(bank, null, 2), 'utf8');
